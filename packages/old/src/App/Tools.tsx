    ...
    <View>
      <Container>
        <Box sx={{ mb: 2 }}>
          ...
          <Typography>
            I develop using <strong>Python</strong>. My framework of choice is{" "}
            <strong>Django</strong>. I also develop front-end applications using{" "}
            <strong>React</strong> with <strong>Typescript</strong>. Finally, I
            deploy on VPS running <strong>Ubuntu</strong>.
          </Typography>
          <Typography>
        ...
        <Box sx={{ mb: 2 }}>
          <Typography>
            I'm currently learning <strong>Java</strong> and{" "}
            <strong>Spring Boot</strong>!
          </Typography>
        </Box>

        <Box sx={{ mb: 2 }}>
          <Chip label="java" /> <Chip label="spring boot" />
        </Box>
